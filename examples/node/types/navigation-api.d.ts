...
declare class DOMNavigation extends EventTarget {
	...
	onnavigate: ((this: DOMNavigation, ev: NavigateEvent) => any) | null;
	onnavigatesuccess: ((this: DOMNavigation, ev: Event) => any) | null;
	onnavigateerror: ((this: DOMNavigation, ev: ErrorEvent) => any) | null;
	oncurrententrychange:
		| ((this: DOMNavigation, ev: NavigationCurrentEntryChangeEvent) => any)
		| null;

	addEventListener<K extends keyof NavigationEventMap>(
		type: K,
		listener: (this: DOMNavigation, ev: NavigationEventMap[K]) => any,
